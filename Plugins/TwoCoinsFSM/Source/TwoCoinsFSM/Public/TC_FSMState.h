...
#include "TC_FSMStateInterface.h"
 ...
 */
UCLASS(Abstract)
class TWOCOINSFSM_API UTC_FSMState : public UObject, public ITC_FSMStateInterface
{
	GENERATED_BODY()

	// ITC_FSMStateInterface
public:
...
public:
	...
	virtual void UpdateState(float deltaSecond);
	...
	bool IsAllowedToSelfTransition() const
	{
		return bAllowedToSelfTransition;
	}
